...
export const WILD_CARDS: CardDefinition[] = [
  ...
  trap({ id: "thorn-barricade", name: "Thorn Barricade", set: "wildgrove", family: "wild", cost: 3, text: "When an enemy unit attacks, destroy that attacker and cancel the attack.", trigger: "enemy-attack", effect: { kind: "destroy-attacker", cancelAttack: true }, artLabel: "Wall", visualTheme: "snare" })
];
