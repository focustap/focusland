...
export const WILD_CARDS: CardDefinition[] = [
  ...
  spell({ id: "sap-surge", name: "Sap Surge", set: "wildgrove", family: "wild", cost: 3, text: "Heal your hero for 3 and draw 1 card.", effects: [{ kind: "heal-hero", amount: 3, target: "self" }, { kind: "draw", amount: 1, target: "self" }], artLabel: "Sap", visualTheme: "vine" }),
  ...
  trap({ id: "thorn-barricade", name: "Thorn Barricade", set: "wildgrove", family: "wild", cost: 3, text: "When an enemy unit attacks, return that attacker to its owner's hand and cancel the attack.", trigger: "enemy-attack", effect: { kind: "bounce-attacker", cancelAttack: true }, artLabel: "Wall", visualTheme: "snare" })
];
