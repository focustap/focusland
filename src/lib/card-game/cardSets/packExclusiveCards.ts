...
export const PACK_EXCLUSIVE_CARDS: CardDefinition[] = [
  ...
  trap({
    ...
    family: "tide",
    cost: 2,
    text: "When your opponent casts a spell, deal 4 damage to that player.",
    trigger: "enemy-spell",
    effect: { kind: "damage-spell-owner", amount: 4 },
    artLabel: "Mirror",
    visualTheme: "wire"
  }),
  unit({
  ...
  trap({
    ...
    family: "iron",
    cost: 3,
    text: "When your opponent casts a spell, they pay 2 more or it is countered.",
    trigger: "enemy-spell",
    effect: { kind: "spell-tax", taxAmount: 2 },
    artLabel: "Grid",
    visualTheme: "wire"
  }),
  unit({
