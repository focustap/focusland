...
export const TIDE_CARDS: CardDefinition[] = [
  ...
  trap({ id: "riptide-sigil", name: "Riptide Sigil", set: "tideveil", family: "tide", cost: 3, text: "When an enemy unit attacks, destroy that attacker and cancel the attack.", trigger: "enemy-attack", effect: { kind: "destroy-attacker", cancelAttack: true }, artLabel: "Riptide", visualTheme: "wire" })
];
