...
export const CAMPFIRE_CARD_PACKS: CampfireCardPack[] = [
  {
    "id": "main-deck",
    "name": "Main Deck",
    "description": "Imported main deck. Enabled by default.",
    "prompts": [
      ...
      "In an attempt to reach a wider audience, the Royal Ontario Museum has opened an interactive exhibit on ______.",
    ...
    "answers": [
      ...
      "Calling the cops on a innocent Black man.",
  ...
  },
  {
    ...
    "description": "Imported expansion pack.",
    "prompts": [
  ...
  },
  {
    "id": "a-i-pack",
    "name": "A.I. Pack",
    "description": "Incomplete imported add-on pack. Enable alongside a complete pack.",
    "prompts": [],
    "answers": [
